...
$banner_title = get_theme_mod( oProfile\Theme\Customizer\Setting\Banner_Title::ID );
$banner_description = get_theme_mod( oProfile\Theme\Customizer\Setting\Banner_Description::ID );
$banner_image_id = get_theme_mod( oProfile\Theme\Customizer\Setting\Banner_Image::ID );
?>
<section
    class="banner"
    <?php

...
<main class="main">
    ...
    <?php
    $developerTechnologyModel = new oProfile\Model\DeveloperTechnology;

    $technologies = $developerTechnologyModel->getTechnologies(
        get_the_ID()
    );
            ...
            <main class="technology-list__content">
                <?php foreach ( $technologies as $technology ) :
                    ...
                    <article class="technology">
                        ...
                        <footer>
                            <?php
                            $levelName = oProfile\Model\DeveloperTechnology::getLevelName(
                                $technology['level']
                            );
                            ?>
